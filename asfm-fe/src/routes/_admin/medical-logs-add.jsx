...
function AddMedicalLogPage() {
  ...
  // Filter animals - show fostered animals only for now
  const filteredAnimals = (animals || []).filter((a) => a.foster_status === 'FOSTERED');
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      const response = await apiClient.post('/medical-logs', {
        ...formData,
